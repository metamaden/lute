...
We can view the scatterplot of the RMSEs for the non-transformed data 
...
The final plot shows scatterplots of the bias, or proportions. The true cell type
proportions are on the x-axis, the predicted proportions are on the y-axis, and
the reference line with a slope of 1 and intercept of 0 is also shown.

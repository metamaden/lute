...
To visualize the results of the deconvolution experiment, we 
suggesting using functions such as the 
[`plot_composition_bar()` function](https://research.libd.org/DeconvoBuddies/reference/plot_composition_bar.html) 
from the `DeconvoBuddies` package. This function generates a bar plot of the 
cell compositions estimates. 
